...
export default function Sidebar() {
  const { activeMenu, setActiveMenu, screenSize } = useContext(NavContext);
            ...
            {activeMenu && (
              <>
                <div className="flex justify-between items-center">
                  <Logo className="" />
                  {/* <Tooltip content="Menu" placement="BottomCenter"> */}
                    <button
                      className=" text-4xl mt-4 p-3 block hover:bg-light-gray  md:hidden font-bold"
                      onClick={() =>
